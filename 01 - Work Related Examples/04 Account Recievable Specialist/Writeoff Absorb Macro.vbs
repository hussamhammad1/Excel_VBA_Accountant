 ...
 For rowww = 2 To lr
    'If Range("R" & rowww).Value = "Inform*" Then
        With Mail_Object.CreateItem(o)
                ...
                .HTMLbody = "<font size=""10pt"" face=""Calibri"" color="""">" & "Hello," & "<br><br>" & "Please absorb the following rejection for:" & "<br><br>" & "Client: " & Range("E" & rowww).Value & "<br><br>" & "Rejected Date: " & Range("F" & rowww).Value & "<br>" & "<font size=""10pt"" face=""Calibri"" color=""red"">" & "<B>Number of hours:</B> " & "<br>" & "<font size=""10pt"" face=""Calibri"" color=""black"">" & "<B>" & Range("I" & rowww).Value & " Hrs</b>" & "<br><br><br><br><br><br>" & "Thank you,"
                .Send
                '.display 'disable display and enable send to send automatically
        End With
        Range("R" & rowww).Value = "Email sent to Nurse/CSC"
    'End If
 Next rowww
